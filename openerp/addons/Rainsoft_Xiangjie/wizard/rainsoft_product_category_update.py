...
class rainsoft_product_category_update(osv.Model):
		...
		def btn_ok(self,cr,uid,ids,context=None):
				...
				for category in categories:
						...
						category.write({
								'property_account_creditor_price_difference_categ':creditor,
								'property_account_income_categ':income,
								'property_account_expense_categ':expense,
								'property_stock_account_input_categ':input_category,
								'property_stock_account_output_categ':output_category,
								'property_stock_valuation_account_id':valuation,
								})
